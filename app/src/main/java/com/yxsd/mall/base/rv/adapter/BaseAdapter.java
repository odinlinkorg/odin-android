package com.yxsd.mall.base.rv.adapter;
...
import com.yxsd.mall.base.rv.listener.OnItemClickListener;
import com.yxsd.mall.base.rv.listener.OnItemLongClickListener;
...
public abstract class BaseAdapter<M> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected void bindCustomViewHolder(final BaseViewHolder holder, final int position) {
        ...
        bind(holder, ObjectUtils.isNotEmpty(mData) && mData.size() > dataPos ? mData.get(dataPos) : null, position);
    }

    protected abstract void bind(final BaseViewHolder holder, final M data, final int position);
